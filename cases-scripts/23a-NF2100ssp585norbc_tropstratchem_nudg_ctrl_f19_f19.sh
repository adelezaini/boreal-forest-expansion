...
### FUT_CTRL RUN
# Nudging
# Initial file: NF2100ssp585norbc_tropstratchem_spinup_f19_f19-3 (0021-01-01)
# 10 years to start
# Land controlled to PD
...
today=$(date +'%Y%m%d')
CASENAME="NF2100ssp585norbc_tropstratchem_nudg_ctrl_f19_f19-$today"
