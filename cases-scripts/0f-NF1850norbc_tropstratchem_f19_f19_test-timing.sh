...
# NF18500_tropstratchem test case to check timing performance and optimize it
# change improve_performance -v B and casename accordingly
...
today=$(date +'%Y%m%d')
testname="test-$today"
export CASENAME="NF1850norbc_tropstratchem_f19_f19_${testname}_timing_Z"
