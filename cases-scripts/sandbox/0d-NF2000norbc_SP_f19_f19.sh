...
# NF2000 test case to see SP run: whih namelist and files it poitns to

# Simulation specifics:
export CASENAME=NF2000norbc_SP_f19_f19_test
export PROJECT=nn9188k
export NORESM_ROOT=/cluster/home/$USER/NorESM2.3_beta01
export COMPSET=2000_CAM60%NORESM%NORBC_CLM50%SP_CICE%PRES_DOCN%DOM_MOSART_SGLC_SWAV 
export RES=f19_f19
...
cat << EOF >> user_nl_cam
 ...
 fincl1 = 'FSNT','FLNT','FSNT_DRF','FLNT_DRF','FSNTCDRF','FLNTCDRF','FLNS','FSNS','FLNSC','FSNSC',
'FSDSCDRF','FSDS_DRF','FSUTADRF','FLUTC','FSUS_DRF','FLUS',
'PS','LANDFRAC', 'PRECC','PRECL','PRECT',

'MEG_isoprene','MEG_monoterp', 'SFisoprene','SFmonoterp', 'isoprene_SRF', 'monoterp_SRF',

'cb_H2SO4','cb_SOA_LV','cb_SOA_NA','cb_SO4_NA', 'cb_isoprene','cb_monoterp',
'SO2', 'H2SO4','SOA_LV', 'SOA_SV', 'SOA_NA', 'SO4_NA', 'isoprene','monoterp',
...
'CCN1','CCN2','CCN3','CCN4','CCN5','CCN6','CCN7','CCN_B',
'NUCLRATE','FORMRATE','GRH2SO4','GRSOA','GR','COAGNUCL',

'CLOUD','FCTL','FCTI','CLDTOT','CDNUMC', 'TGCLDCWP',

'AOD_VIS','CAODVIS','AEROD_v','CLDFREE', 'CABS550','CABS550A', 
'O3', 'OH_aft', 'OH_bef',

'NNAT_0','CDOD550','CDOD440','CDOD870',' SST', 'ozone', 'OH_vmr', 
'TROP_P','TROP_T','TROP_Z','VT100'
